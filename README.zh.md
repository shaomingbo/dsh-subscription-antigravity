...
```bash
npx --yes github:shaomingbo/dsh-subscription-antigravity#v0.1.4
```
...
```bash
npx --yes github:shaomingbo/dsh-subscription-antigravity#v0.1.4 status
npx --yes github:shaomingbo/dsh-subscription-antigravity#v0.1.4 uninstall
```
...
```bash
npx --yes github:shaomingbo/dsh-subscription-antigravity#v0.1.4 install \
...
`"dsh-subscription-antigravity": "github:shaomingbo/dsh-subscription-antigravity#v0.1.4"`，
